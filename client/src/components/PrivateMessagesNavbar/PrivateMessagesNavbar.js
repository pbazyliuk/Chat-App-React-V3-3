...
import styles from './PrivateMessageNavbar.scss';

class PrivateMessagesNavbar extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		return (
			<div className={styles['chat-details-navbar']}>
				<Link to="/chat" className={styles['btn-back']} />
...
export default connect(null, actions)(PrivateMessagesNavbar);

            ...
            <li className={styles['user-message-author']}>
                <div className={ styles['user-message-wrapper'] } >
                    ...
                    <div className={ styles['user-message__text-cotainer'] }>
                        ...
                        <div className={ styles['user-message__text-message'] }>{text}</div>
                    </div>
                    
                </div>

                <div className={ styles['user-message__date-container'] }>
                    <span className={ styles['user-message__date'] }>{moment(sentAt).add(10, 'days').calendar()}</span>
                    <br/>
                    <span className={ styles['user-message__time'] }>{moment(sentAt).format('h:mm a')}</span>
                </div>
            </li>
    )
  }
